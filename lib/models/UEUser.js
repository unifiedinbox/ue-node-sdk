...
export default class User {
    ...
    addConnection(connectionName, service, serviceAccessToken) {
        ...
        return new Promise((resolve,reject) => {
            ...
            .then(connection => {
                const ueConnection = new UEConnection(connectionName, connectionUri, this );
    ...
    listConnections() {
        ...
        return new Promise(( resolve, reject ) => {
            ...
            .then(response  => {
                // Parse response and create UEConnection objects
                const connectionsResponse = response.connections;
                const connections = (() => {
                    let connectionObjects = [];
                    for(var key of Object.keys(connectionsResponse)){
                        const connection = new UEConnection( key,connectionsResponse[key].uri, this)
